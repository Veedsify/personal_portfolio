...
import { useScrollAnimation } from "@/app/context/useScrollAnimation";
          ...
          <div className="container">
            ...
            <div className="m-titles align-center">
              ...
              >
                ...
                <a href="blog.html">UI Design</a> / October 31, 2022 / by admin
              </div>
              <h1
        ...
        <div className="section section-inner m-image-large">
          ...
          <div className="image">
            <div
              ...
              data-animate="active"
              style={{ backgroundImage: "url(/images/single7.jpg)" }}
            ></div>
          </div>
        </div>
                ...
                <div className="description">
                  ...
                  >
                    <p>
                      ...
                      felis. Ut dignissim sapien sit amet molestie rutrum. Orci
                      varius natoque penatibus et magnis dis parturient montes,
                      nascetur ridiculus mus. Pellentesque in porta dolor, a
                      suscipit risus. Lorem ipsum dolor sit amet, consectetur
                      adipiscing elit. Cras ac arcu in lorem rhoncus
                      ullamcorper. Ut at nulla ut libero mollis viverra sed
                      vitae purus.
                    </p>
                    <p>
                      Nam dui mauris, congue vel nisi in, tempus gravida enim.
                      Nulla et tristique orci. Pellentesque lectus sapien,
                      maximus id gravida sit amet, tristique non eros. Etiam
                      aliquet, sem vitae sagittis convallis, ante sapien
                      tincidunt nisl, eget dapibus tortor velit quis ex. Proin
                      et condimentum est, sed pretium ex. Mauris posuere est
                      metus, vitae commodo sem posuere eget. Praesent maximus
                      augue rutrum, consequat magna id, facilisis lorem. Quisque
                        ...
                        <div className="comment comment-box">
                          ...
                          <div className="comment-box__body">
                            <div className="content-caption post-content description">
                              ...
                              <p>
                                Nam dui mauris, congue vel nisi in, tempus
                                gravida enim. Nulla et tristique orci.
                                Pellentesque lectus sapien, maximus id gravida
                                sit amet, tristique non eros. Etiam aliquet, sem
                                vitae sagittis convallis, ante sapien tincidunt
                                nisl, eget dapibus tortor velit quis ex.
                              </p>
                            </div>
                          </div>
                          ...
                          <div className="comment-box__body">
                            <div className="content-caption post-content description">
                              ...
                              <p>
                                ...
                                posuere est metus, vitae commodo sem posuere
                                eget.
                              </p>
                            </div>
                          </div>
