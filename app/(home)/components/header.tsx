...
const Header = () => {
  const handleMenuOpenClick: React.MouseEventHandler<HTMLImageElement> = (
    e
  ) => {
    ...
    if (e.target instanceof HTMLImageElement) {
      if (e?.target.classList.contains("active")) {
        ...
        e.target.classList.add("no-touch");
        document.body.classList.remove("no-scroll");
        menuOverLay?.classList.remove("is-open");
        menuOverLay?.classList.remove("has-scroll");
        menuOverLay?.classList.remove("animate-active");
        setTimeout(() => {
          menuOverLay?.classList.remove("visible");
          if (e.target instanceof HTMLImageElement) {
            e?.target?.classList.remove("no-touch");
            document
        ...
        e?.target.classList.add("no-touch");
        menuOverLay?.classList.add("no-touch");
        document.body.classList.add("no-scroll");
        menuOverLay?.classList.add("is-open");
        menuOverLay?.classList.add("visible");
        setTimeout(() => {
          menuOverLay?.classList.add("has-scroll");
          menuOverLay?.classList.add("animate-active");
          if (e.target instanceof HTMLImageElement) {
            e?.target?.classList.remove("no-touch");
            if (e.target instanceof HTMLImageElement) {
              document
        ...
        <div className="header__builder">
          <div className="row">
            ...
            <div className="col-xs-8 col-sm-8 col-md-8 col-lg-8 align-right">
              {/* <!-- switcher btn --> */}
              <Link href="#" className="switcher-btn">
              ...
              <div className="menu-full-overlay">
                <div className="menu-full-container p-5">
